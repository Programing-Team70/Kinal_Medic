...
export const Sidebar = () => {
  ...
  const items = [
    { label: 'Registro Médico', to: '/dashboard/medical' },
    { label: 'Inventario Médico', to: '/dashboard/inventory' },
    { label: 'Notificaciones', to: '/dashboard/notification' },
    { label: 'Estados Profesor', to: '/dashboard/availability' },
